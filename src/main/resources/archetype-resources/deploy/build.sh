...
CODE_HOME=/home/admin/code/${parentArtifactId}
JAVA_HOME=/Users/home/java/
PACKAGE_COMMAND="mvn clean package -Dmaven.test.skip=true -P$MAVEN_ENV"
JAR_NAME=${parentArtifactId}-1.0-SNAPSHOT.jar
config=config.json
APP_PNAME=demo-1.0
APP_PORT=6109
APP_CHECK_URL="http://localhost6091/index"
...
nohup ${JAVA_HOME}/java -jar ${JAR_NAME} -conf ${config} &
